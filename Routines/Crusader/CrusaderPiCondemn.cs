...
namespace Trinity.Routines.Crusader
{
    ...
    public sealed class CrusaderPiCondemn : CrusaderBase, IRoutine
    {
        #region Definition

        public string DisplayName => "Crusader tianqian";
        public string Description => "";
        public string Author => "Nesox, pipixia";
        ...
        public CrusaderPiCondemnSettings Settings { get; } = new CrusaderPiCondemnSettings();

        public sealed class CrusaderPiCondemnSettings : NotifyBase, IDynamicSetting
        {
